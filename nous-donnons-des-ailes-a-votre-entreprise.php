...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo AILESTITRE; ?></title>
		<meta name="description" content="<?php echo META_DESC_AILES; ?>">
	...
	<body>
		...
		<div id="root">
			<header id="top">
				...
				<article id="featured" style="padding:70px 0">
					<h2><?php echo AILES_ENTETE; ?></h2>
					<h5 style="text-align:left"><?php echo AILES_ENTETETXT; ?></h5>
				</article> 
				<figure><img src="liaisons/images/backgrounds/donner-des-ailes.jpg" alt="Featured" width="1400" height="442"></figure>               
			</header>  
			<section id="content" class="cols-a">
				<div class="news-a">
					<article style="border:none">
						<header>
							<h6><?php echo AILES_TITRE1;?></h6>
						</header>
						<p><?php echo AILES_TXT1; ?></p>
                        
						<header>
							<h6><?php echo AILES_TITRE2;?></h6>
						</header>
						<p><?php echo AILES_TXT2; ?></p>
        ...
        <!-- Custome Slider  -->
        <script src="js-menu/main.js"></script>		<script type="text/javascript">
