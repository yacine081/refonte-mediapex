...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo MEDIAPEX_DIGITAL; ?></title>
		<meta name="description" content="<?php echo MEDIAPEX_DIGITAL_META_DESC; ?>">
		...
		<div id="root">
			<header id="top">
				...
				<article id="featured" style="padding:70px 0">
					<h2><?php echo MEDIAPEX_DIGITAL; ?></h2>
					<p><?php echo MEDIAPEX_DIGITAL_SOUS_TITRE; ?></p>
				</article> 
				<figure><img src="liaisons/images/backgrounds/mediapex-digital.jpg" alt="Featured" width="1400" height="442"></figure>               
			</header>  
			<section id="content" class="cols-a">
				...
				<div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="site-internet">
						<div style="padding:5%">
							<img src="liaisons/images/produits/site-internet-petit.jpg" width="80%" style="padding:10%; background:#fff; margin-bottom:15px"><?php echo MEDIAPEX_DIGITAL_SITE_INTERNET;?>
						</div>
						</a>
					</div>
				</div><div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="community-management">
						<div style="padding:5%">
							<img src="liaisons/images/produits/community-management-petit.jpg" width="80%" style="padding:10%; background:#fff; margin-bottom:15px"><?php echo MEDIAPEX_DIGITAL_COMMUNITY_MANAGEMENT; ?>
						</div>
						</a>
					</div>
				</div><div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="application-web">
						<div style="padding:5%">
							<img src="liaisons/images/produits/application-web-petit.jpg" width="80%" style="padding:10%; background:#fff; margin-bottom:15px"><?php echo MEDIAPEX_DIGITAL_APPLICATION_WEB; ?>
						</div>
						</a>
					</div>
				</div><div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="application-mobile">
						<div style="padding:5%">
							<img src="liaisons/images/produits/application-mobile-petit.jpg" width="80%" style="padding:10%; background:#f0f1f2; margin-bottom:15px"><?php echo MEDIAPEX_DIGITAL_APPLICATION_MOBILE; ?>
						</div>
						</a>
					</div>
				</div>
