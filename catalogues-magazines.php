...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo PROD_CATALOGUES_MAGAZINES; ?> - Médiapex</title>
		<meta name="description" content="<?php echo CATALOGUES_MAGAZINES_META_DESC; ?>">
	...
	<body>
		<div id="root">
			...
			<div class="voircatalogue" style="font-size:30px; font-weight:300; background:#068c94"><?php echo PROD_CATALOGUES_MAGAZINES; ?></div> 
			<section id="content" class="cols-a">
				<div class="news-a">
					<article style="border:none">
						
						<img src="liaisons/images/produits/catalogues-magazines.jpg" width="100%">
						
						<br>
						<br>
						<br>
						<?php echo CATALOGUES_MAGAZINES_TXT; ?>
