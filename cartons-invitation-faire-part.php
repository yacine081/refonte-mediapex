...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo PROD_CARTONS_INVITATION; ?> - Médiapex</title>
		<meta name="description" content="<?php echo CARTONS_INVITATION_META_DESC; ?>">
	...
	<body>
		<div id="root">
			...
			<div class="voircatalogue" style="font-size:30px; font-weight:300; background:#068c94"><?php echo PROD_CARTONS_INVITATION; ?></div> 
			<section id="content" class="cols-a">
				<div class="news-a">
					<article style="border:none">
						
						<img src="liaisons/images/produits/carton-invitation-faire-part.jpg" width="100%">
						
						<?php echo CARTONS_INVITATION_TXT; ?>
