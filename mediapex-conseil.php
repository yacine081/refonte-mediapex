...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo MEDIAPEX_CONSEIL; ?></title>
		<meta name="description" content="<?php echo MEDIAPEX_CONSEIL_META_DESC; ?>">
		...
		<div id="root">
			<header id="top">
				...
				<article id="featured" style="padding:70px 0">
					<h2><?php echo MEDIAPEX_CONSEIL; ?></h2>
					<p style="max-width:750px; line-height:1.1em"><?php echo MEDIAPEX_CONSEIL_SOUS_TITRE; ?></p>
				</article> 
				<figure><img src="liaisons/images/backgrounds/mediapex-conseil.jpg" alt="Featured" width="1400" height="442"></figure>               
			</header>  
			<section id="content" class="cols-a" style="padding-bottom:200px">
				<div class="news-a" style="width:100%; text-align:center">
				
				<div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="conseil-marketing">
						<div style="padding:5%">
							<img src="liaisons/images/produits/neutre.png" width="80%" style="padding:10%; background:url(liaisons/images/produits/conseil-marketing-petit.jpg) right; background-size:cover; margin-bottom:15px"><?php echo MEDIAPEX_CONSEIL_CONSEIL_MARKETING; ?>
						</div>
						</a>
					</div>
				</div><div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="audit-image">
						<div style="padding:5%">
							<img src="liaisons/images/produits/neutre.png" width="80%" style="padding:10%; background:url(liaisons/images/produits/audit-image-petit.jpg) right; background-size:cover; margin-bottom:15px"><?php echo MEDIAPEX_CONSEIL_AUDIT_IMAGE; ?>
						</div>
						</a>
					</div>
				</div><div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="relation-presse">
						<div style="padding:5%">
							<img src="liaisons/images/produits/neutre.png" width="80%" style="padding:10%; background:url(liaisons/images/produits/relation-presse-petit.jpg) center; background-size:cover; margin-bottom:15px"><?php echo MEDIAPEX_CONSEIL_RELATION_PRESSE; ?>
						</div>
						</a>
					</div>
				</div>
