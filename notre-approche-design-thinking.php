...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo DESIGNTHINKINGTITRE; ?></title>
		<meta name="description" content="<?php echo META_DESC_DESIGN_THINKING; ?>">
		...
		<div id="root">
			<header id="top">
				...
				<article id="featured" style="padding:70px 0">
					<h2><?php echo DS_ENTETE; ?></h2>
					<h5><?php echo DS_ENTETETXT; ?></h5>
				</article> 
				<figure><img src="liaisons/images/backgrounds/design-thinking.jpg" alt="Featured" width="1400" height="442"></figure>               
			</header>  
			<section id="content" class="cols-a">
				<div class="news-a">
					<article style="border:none">
						<header>
							<h6><?php echo DS_TITRE;?></h6>
						</header>
