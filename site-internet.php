...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo PROD_SITE_INTERNET; ?> - Médiapex</title>
		<meta name="description" content="<?php echo SITE_INTERNET_META_DESC; ?>">
	...
	<body>
		...
		<div id="root">
			...
			<div class="voircatalogue" style="font-size:30px; font-weight:300; background:#068c94"><?php echo PROD_SITE_INTERNET; ?></div> 
