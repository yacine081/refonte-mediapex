...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo MEDIAPEX_EVENTS; ?></title>
		<meta name="description" content="<?php echo MEDIAPEX_EVENTS_META_DESC; ?>">
		...
		<div id="root">
			<header id="top">
				...
				<article id="featured" style="padding:70px 0">
					<h2><?php echo MEDIAPEX_EVENTS; ?></h2>
					<p style="max-width:700px; line-height:1.1em"><?php echo MEDIAPEX_EVENTS_SOUS_TITRE; ?></p>
				</article> 
				<figure><img src="liaisons/images/backgrounds/mediapex-events.jpg" alt="Featured" width="1400" height="442"></figure>               
			</header>  
			<section id="content" class="cols-a">
				...
				<div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="lancement-produit-service">
						<div style="padding:5%">
							<img src="liaisons/images/produits/neutre.png" width="80%" style="padding:10%; background:url(liaisons/images/produits/lancement-produit-service-petit.jpg) center; background-size:cover; margin-bottom:15px"><?php echo MEDIAPEX_EVENTS_LANCEMENT_PRODUIT; ?>
						</div>
						</a>
					</div>
				</div><div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="seminaire">
						<div style="padding:5%">
							<img src="liaisons/images/produits/neutre.png" width="80%" style="padding:10%; background:url(liaisons/images/produits/seminaire-petit.jpg) center; background-size:cover; margin-bottom:15px"><?php echo MEDIAPEX_EVENTS_SEMINAIRE; ?>
						</div>
						</a>
					</div>
				</div><div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="soiree-gala">
						<div style="padding:5%">
							<img src="liaisons/images/produits/neutre.png" width="80%" style="padding:10%; background:url(liaisons/images/produits/soiree-gala-petit.jpg) center; background-size:cover; margin-bottom:15px"><?php echo MEDIAPEX_EVENTS_GALA; ?>
						</div>
						</a>
					</div>
				</div><div class="colonne4">
					<div style="padding:0 2%; margin-bottom:5%">
						<a class="voirproduit" href="tournee-promotionnelle">
						<div style="padding:5%">
							<img src="liaisons/images/produits/neutre.png" width="80%" style="padding:10%; background:url(liaisons/images/produits/tournee-promotionnelle-petit.jpg) center; background-size:cover; margin-bottom:15px"><?php echo MEDIAPEX_EVENTS_TOURNEE; ?>
						</div>
						</a>
					</div>
				</div>
