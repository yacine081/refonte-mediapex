...
{ ?>
		...
		<div id="root">
			<header id="top" style="height:0px">


				<article id="featured" style="display:none">
					<h2><?php echo NOSREFERENCES; ?></h2>
					<p><?php echo NOSREFERENCESTXT; ?></p>
				</article> 
				<figure><img src="liaisons/images/backgrounds/references2.jpg" alt="Featured" width="1400" height="442"></figure>               
			</header>  
            
			<!--<section id="content" style="padding-top:0">-->
            
			<iframe id="references" width="100%" frameborder="0" allowtransparency="1" src="liaisons/portfolio/index.php?client=<?php echo $_GET['client']; ?>" style="min-height:600px"></iframe>
