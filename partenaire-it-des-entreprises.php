...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo PARTENAIRETITRE; ?></title>
		<meta name="description" content="<?php echo META_DESC_PARTENAIRE; ?>">
		...
		<div id="root">
			<header id="top">
				...
				<article id="featured" style="padding:70px 0">
					<h2><?php echo PARTENAIRE_ENTETE; ?></h2>
					<h5 style="text-align:left; color: white !important;"><?php echo PARTENAIRE_ENTETETXT; ?></h5>
				</article> 
				<figure><img src="liaisons/images/backgrounds/partenaire-it.jpg" alt="Featured" width="1400" height="442"></figure>               
			</header>  
			<section id="content" class="cols-a">
				<div class="news-a">
					<article style="border:none">
						
						<p><?php echo PARTENAIRE_TXT; ?></p>
					</article>
