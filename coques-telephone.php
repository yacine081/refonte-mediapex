...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo PROD_COQUES_TELEPHONE; ?> - Médiapex</title>
		<meta name="description" content="<?php echo COQUES_TELEPHONE_META_DESC; ?>">
	...
	<body>
		<div id="root">
			...
			<div class="voircatalogue" style="font-size:30px; font-weight:300; background:#068c94"><?php echo PROD_COQUES_TELEPHONE; ?></div> 
			<section id="content" class="cols-a">
				<div class="news-a">
					<article style="border:none">
						
						<img src="liaisons/images/produits/coques-telephone.jpg" width="100%">
						
						<br>
						<?php echo COQUES_TELEPHONE_TXT; ?>
