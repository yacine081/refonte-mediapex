...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo AGENCECOMTITRE; ?></title>
		<meta name="description" content="<?php echo META_DESC_AGENCE_COM; ?>">
        ...
        <style>
			...
			h5{text-align: justify; color: white !important;}
	...
	<body>
		...
		<div id="root">
			<header id="top">
				...
				<article id="featured" style="padding:50px 0">
					<h2><?php echo AC_ENTETE; ?></h2>
					<h5><?php echo AC_ENTETETXT; ?></h5>
				</article> 
				<figure><img src="liaisons/images/backgrounds/agence-globale.jpg" alt="Featured" width="1400" height="442"></figure>               
			</header>  
			<section id="content" class="cols-a" style="  color: black !important;">
				<div class="news-a" >
					<article style="border:none">
						<header>
							<h6><?php echo AC_TITRE;?></h6>
						</header>
						
						<p style="color: black !important!"><?php echo AC_TXT;?></p>
					</article>
