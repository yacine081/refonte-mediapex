...
<html lang="<?php echo $lang; ?>">
    <head>
        <meta charset="UTF-8">
		<title><?php echo PROD_AGENDAS; ?> - Médiapex</title>
		<meta name="description" content="<?php echo AGENDAS_META_DESC; ?>">
	...
	<body>
		...
		<div id="root">
			...
			<div class="voircatalogue" style="font-size:30px; font-weight:300; background:#068c94"><?php echo PROD_AGENDAS; ?></div> 
			<section id="content" class="cols-a">
				<div class="news-a">
					<article style="border:none">
						
						<img src="liaisons/images/produits/agendas.jpg" width="100%">
						
						<br>
						<br>
						<br>
						<?php echo AGENDAS_TXT; ?>
